...
TASK_MESSAGES = {
    ...
    "CONFIRM_BOOK": (
        ...
        "re-offer matching times (or answer), then re-confirm. Asks what we offer "
        "or wants a different kind? Name them (General Practice, Therapy, "
        "Psychiatry, Dermatology, Physiotherapy) and re-list — never refuse. "
        "Set notes only if "
